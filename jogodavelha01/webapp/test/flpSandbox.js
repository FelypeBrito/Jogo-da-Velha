		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Jogo da Velha 01",
									"targetURL": "#jogodavelha01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jogodavelha01-display": {
								"semanticObject": "jogodavelha01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jogodavelha01",
									"url": sap.ui.require.toUrl("jogodavelha01")
								}
							}
						}
					}
